...
public class ModMakerApp extends JFrame {
    ...
    public ModMakerApp() {
        ...
        removeButton.addActionListener(e -> {
            ...
            if (selectedIndex != -1) {
                ...
                queuedElements.remove(selectedIndex);
            }
        });
        queuePanel.add(removeButton, BorderLayout.SOUTH);
    ...
    private void addEntity(ActionEvent e) {
        ...
        if (name.isEmpty() || entityTexture == null) {
            JOptionPane.showMessageDialog(this, "Please provide a name and texture.");
            return;
        }
    ...
    private void addBlock(ActionEvent e) {
        ...
        if (name.isEmpty() || blockTopTexture == null || blockBottomTexture == null || blockSideTexture == null) {
            JOptionPane.showMessageDialog(this, "Please enter a block name and select all textures.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void addItem(ActionEvent e) {
        ...
        if (name.isEmpty() || itemSelectedTexture == null) {
            JOptionPane.showMessageDialog(this, "Please enter an item name and select a texture.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
